...
- **Clean-change gate.** Do not continue while the current JJ change modifies any file in `scope.mutable` or `scope.immutable`. The reference owns the check and what to ask for.
