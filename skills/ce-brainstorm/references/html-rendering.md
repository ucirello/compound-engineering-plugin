...
HTML defaults can add `DESIGN.md` to the active workspace.
...
Resolve the repository's configured remotes with Jujutsu once at compose time,
then select the GitHub remote the references name (normally `origin`):
