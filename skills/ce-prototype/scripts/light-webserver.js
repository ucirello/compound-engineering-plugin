...
const IDLE_TIMEOUT_MS = Number(process.env.PROTOTYPE_WEB_IDLE_TIMEOUT_MS) || 30 * 60 * 1000
const LIFECYCLE_CHECK_MS = Number(process.env.PROTOTYPE_WEB_LIFECYCLE_CHECK_MS) || 60 * 1000
...
<body>
  <header>Local prototype - newest screen, reloads on change</header>
  <main>${content}</main>
