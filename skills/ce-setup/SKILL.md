...
4. Check whether `.compound-engineering/config.local.yaml` exists and, if it does, whether the project ignore rules cover `.compound-engineering/*.local.yaml` or `.compound-engineering/config.local.yaml`.
