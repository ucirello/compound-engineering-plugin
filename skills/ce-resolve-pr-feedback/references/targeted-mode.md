...
Before making edits or dispatching a fixer, read Full Mode step 4 in `references/full-mode.md`; its PR-head guard, effective configuration, and OpenCode V2 native-model routing govern this mode too.
