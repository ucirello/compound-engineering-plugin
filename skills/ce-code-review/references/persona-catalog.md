...
6. **For RocketClaw conditional prompt assets**, use `deployment-verification-agent` when the migration-artifact condition applies and the change is risky (see above).
