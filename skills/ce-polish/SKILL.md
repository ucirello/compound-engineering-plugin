...
**Boundaries:** the user drives what to inspect and change; do not invent an autonomous checklist or expand into general QA. Never edit the repository's default-bookmark revision; work in a mutable feature change. This workflow may edit and locally commit the requested polish, but it never pushes or opens a PR.
