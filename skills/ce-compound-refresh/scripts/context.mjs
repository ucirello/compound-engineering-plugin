...
function buildResolvedContext() {
  ...
  return [
    'RESOLVED_CONTEXT:',
    `cwd: ${process.cwd()}`,
    `jj_root: ${root || '(not a Jujutsu repository)'}`,
...
// A review can promote a finding when "2+ independent personas" agree, while
// nothing verifies they ran in separate processes — inline, one context reasoned
