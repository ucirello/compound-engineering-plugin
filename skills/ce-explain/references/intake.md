...
|-------|---------|--------|
| `diff:<ref-or-range>` | `diff:qpvuntsm`, `diff:main@origin..@`, `diff:PR#42` | Forces diff mode on that change |
...
- **Diff** — the request names a resolvable change: a change ID, bookmark, PR, "the parent change", "what you just did", "this change".
