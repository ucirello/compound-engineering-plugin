...
- **Body:**
  ...
  - Source: a link to the PR when one exists; otherwise the active bookmark (if any), Jujutsu change ID, and commit ID. When the same run later opens a PR, back-fill its URL best-effort.
