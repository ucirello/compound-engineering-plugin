...
Repository-local instructions and observed history take precedence. Where compatible, use imperative mood, capitalize the initial word, omit a terminal period in the subject, keep the subject concise, and use a body only to explain motivation or important consequences.
