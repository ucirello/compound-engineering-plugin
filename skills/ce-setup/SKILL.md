---
name: ce-setup
description: "Check RocketClaw health and repo-local config, or scaffold a RocketClaw Pack with `pack:<id>`."
...
- the health report names an invalid OpenCode model in an explicit plan, brainstorm, or cross-model peer route
