...
working from a workspace who want HTML defaults can add DESIGN.md to that
workspace.
...
Resolve the repo's GitHub URL once at compose time through Jujutsu's Git interoperability:
