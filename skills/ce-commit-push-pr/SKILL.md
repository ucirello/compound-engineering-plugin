...
**Read `references/commit-and-push.md`** for commit/push mechanics and default-bookmark handling via `references/branch-creation.md`. If stack mode committed its layers, skip to Step 4; Step 5 submits them.
