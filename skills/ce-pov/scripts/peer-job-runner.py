...
def _require_detach_support() -> None:
    ...
    message instead of jobs_root_base()'s unrelated "cannot derive the jobs root
    from the workspace .tmp directory" error or an AttributeError mid-detach. Native Windows is now
