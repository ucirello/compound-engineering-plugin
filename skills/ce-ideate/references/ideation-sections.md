...
Keep engineering-process metadata and producer attribution out of the artifact —
no "captured at Phase X" notes, skill-pointer "next steps", provenance lines,
or tool, model, platform, harness, or creator identity. The reader wants the
ideas and their basis.
