...
```
Score each item in this optimization experiment as an independent quality judge.
...
```
Judge singleton items that are currently not in any group or cluster.
