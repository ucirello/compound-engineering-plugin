...
- **Clean-tree gate.** Do not continue while any file in `scope.mutable` or `scope.immutable` has unrecorded working-copy changes. The reference owns the check and what to ask for.
