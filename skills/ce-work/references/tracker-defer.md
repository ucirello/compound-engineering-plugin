...
- **Body:**
  ...
  - Source: a link to the PR carrying this change when one exists; otherwise the relevant bookmark and Jujutsu commit ID. When the same run opens a PR later, back-fill its link best-effort without blocking shipping.
