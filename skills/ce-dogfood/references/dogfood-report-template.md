...
> Diff-scoped browser QA of `<bookmark-or-change>` vs the trunk on <YYYY-MM-DD>.
...
<What changed between the JJ change and trunk: new features, modified behavior, new/changed routes, views, components, data flows. 2-6 bullets.>
...
| # | Flow | Journey / Scenario | Status | Issue | Fix | JJ Commit ID |
|---|------|--------------------|--------|-------|-----|--------|
| 1 |      |                    | Pass   | -     | -   | -      |
| 2 |      |                    | Fixed  |       |     | abc123 |
...
<Overall readiness verdict for the JJ change. Ready to ship? Caveats? Outstanding blocked items? Record the result of the Phase 5 automated test suite run — a green matrix with a red suite is not "ready.">
