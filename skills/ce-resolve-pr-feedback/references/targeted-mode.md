...
Then follow the same validate -> change -> push -> reply -> resolve flow as Full Mode steps 5-7 (in `references/full-mode.md`). Skip validate/change when no code changed.
