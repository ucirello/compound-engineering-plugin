...
#                     workspace root, then the physical current directory.
#
...
#                          the resolved fallback directory is unavailable

set -u

TARGET_PATH="${1:-}"

# Resolve target directory: positional arg, JJ workspace root, or physical CWD.
