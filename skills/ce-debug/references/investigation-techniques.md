...
The test command should exit 0 for good, 1 for bad, and 125 when the revision cannot be tested. JJ leaves the working copy unchanged while it evaluates the candidate revisions.
