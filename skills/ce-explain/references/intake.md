...
|-------|---------|--------|
| `diff:<revision-or-range>` | `diff:abc1234`, `diff:<bookmark>..@`, `diff:PR#42` | Forces diff mode on that change |
...
- **Diff** — the request names a resolvable change: a change ID, commit ID, bookmark, PR, "the current change", "the previous change", "what you just did", "this change".
