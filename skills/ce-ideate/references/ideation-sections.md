...
lines, and no creator, model, agent, platform, or source attribution. The
reader wants the ideas and their basis. HTML carries only a visible
composition timestamp per the html-rendering invariant.
