...
Committed: message composed from the standards above (working copy was clean before review). Based on https://go.dev/wiki/CommitMessage and on past commit messages that you can see in `git log`, compose commit messages adherent to the present standards.
