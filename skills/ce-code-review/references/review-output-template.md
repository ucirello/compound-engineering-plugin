...
**Scope:** JJ common ancestor with the review base bookmark/revision -> working copy (14 files, 342 lines)
...
Described JJ change: `fix(review): cover empty-format branch + tighten export perms` (working copy was clean before review).
