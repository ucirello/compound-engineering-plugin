...
**This skill drafts only. It never posts, publishes, creates changes, or opens PRs.** Posting is a human action. The output is always drafts for you to review, edit, and ship yourself.
...
- **Recent changes** — `jj log -n 15` for the arc of the work.
...
- **Do not post, publish, schedule, create a change, or open a PR.** End by reminding the user the drafts are theirs to ship.
