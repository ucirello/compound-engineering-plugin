...
const IDLE_TIMEOUT_MS = Number(process.env.ROCKETCLAW_LIGHT_WEB_IDLE_TIMEOUT_MS ?? process.env.CE_LIGHT_WEB_IDLE_TIMEOUT_MS) || 30 * 60 * 1000
const LIFECYCLE_CHECK_MS = Number(process.env.ROCKETCLAW_LIGHT_WEB_LIFECYCLE_CHECK_MS ?? process.env.CE_LIGHT_WEB_LIFECYCLE_CHECK_MS) || 60 * 1000
