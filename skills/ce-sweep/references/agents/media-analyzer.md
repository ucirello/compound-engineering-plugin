...
- You are read-only except for the ONE write to your scratch artifact path. Read-oriented `jj log` / `gh` and running the bundled analyzer are permitted; do not edit project files, mutate Jujutsu state, publish bookmarks, or open PRs.
