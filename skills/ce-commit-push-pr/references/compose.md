...
Then continue with the reference (including Step B2 when the teaching gate is on). The reference's final pre-apply audit must run before the body is returned.
