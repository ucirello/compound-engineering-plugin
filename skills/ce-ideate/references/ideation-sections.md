...
lines. The reader wants the ideas and their basis. HTML carries one visible
composition-timestamp footer so readers can judge staleness and may retain an
external input source; it never names the composing skill or a creator.
