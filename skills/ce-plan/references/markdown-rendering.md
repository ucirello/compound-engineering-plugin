...
This information belongs in JJ change descriptions, commit messages, tool output, and agent transcripts — not in the artifact a reader returns to weeks later.
