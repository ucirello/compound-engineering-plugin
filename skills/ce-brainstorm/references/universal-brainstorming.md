...
- **Publish to Proof — shareable link** → load the `ce-proof` skill to publish the doc to Proof and get a shareable link to read, comment on, or share with others (one-way; the local summary stays canonical)
