...
If the file does not yet exist, create the directory and file. If `.compound-engineering/config.local.yaml` is not already covered by repository ignore rules, offer to add the entry before writing.
