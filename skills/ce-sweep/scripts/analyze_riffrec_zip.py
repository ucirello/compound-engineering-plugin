...
def write_analysis_md(
    ...
    lines.append("- Use repository-relative screenshot paths when moving evidence into a requirements document.")
...
def write_source_materials(
    ...
    lines = [
        ...
        "- JJ tracking policy: raw media, audio chunks, zip contents, session dumps, and extracted screenshots are local-only by default; track generated Markdown/JSON/manifests only when useful for brainstorm/planning traceability.",
