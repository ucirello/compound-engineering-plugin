...
# opencode2 is a distinct harness. Surveyed `opencode2 --help` names no unique
# environment marker; when the running CLI is opencode2, attest
# XHOST_HARNESS=opencode2 instead of opencode.
```
