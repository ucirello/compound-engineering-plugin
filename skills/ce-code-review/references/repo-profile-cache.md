...
- The `docs/solutions/` enumeration (a new learning, even newly added in the working-copy change, must be visible — re-globbing it is ~free and the match reads files fresh anyway).
