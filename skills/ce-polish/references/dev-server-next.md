...
- **Monorepo roots:** in a pnpm/Turborepo monorepo, `npm run dev` at the root typically fans out to multiple packages. Users should set `cwd` in `.workspace/launch.json` to the specific Next app (`cwd: "apps/web"`).
