...
- Add a VCS-history analyzer only when historical rationale or prior art is materially missing
...
- Add VCS commands, change choreography, or exact test command recipes
