...
working from an auxiliary workspace who want HTML defaults can add DESIGN.md
to that workspace.
...
- **No producer attribution** appears in the artifact: no tool, model,
  platform, harness, or creator identity.
