...
**Scope:** fork point with the review base bookmark -> working copy (14 files, 342 lines)
...
Committed as an isolated review change (working copy was clean before review).
