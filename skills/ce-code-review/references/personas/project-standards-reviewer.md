...
- **Protected artifact violations** -- findings, suggestions, or instructions that recommend deleting or adding ignore rules for files in paths the standards designate as protected (e.g., `docs/brainstorms/`, `<root>/plans/`, `<root>/solutions/`).
