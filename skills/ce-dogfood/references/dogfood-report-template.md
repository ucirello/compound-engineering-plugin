# Dogfood Report — <bookmark/ref>

> Diff-scoped browser QA of `<bookmark/ref>` vs the trunk. Generated by `/ce-dogfood` on <YYYY-MM-DD>.
...
<What changed between the bookmark/ref and trunk: new features, modified behavior, new/changed routes, views, components, data flows. 2-6 bullets.>
