...
> Diff-scoped browser QA of `<branch>` vs `<resolved base>` on <YYYY-MM-DD>.
...
<What changed from the common ancestor of the resolved base and target to the target: new features, modified behavior, new/changed routes, views, components, data flows. Name the actual PR base or resolved trunk. 2-6 bullets.>
