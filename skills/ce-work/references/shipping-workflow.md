...
- [ ] Change descriptions follow project and Go commit-message standards (see `references/implementation-loop.md`)
...
- [ ] `ce-commit-push-pr` ran (or the project-defined shipping process ran with the same context)
