...
- **Body:**
  ...
  - Source: a link to the PR carrying this change when one exists; otherwise the bookmark plus jj change ID and commit ID. When the same run opens a PR later, back-fill its URL best-effort.
