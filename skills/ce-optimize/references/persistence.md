...
The scratch space under `.context/` is gitignored: it survives a local resume but does not travel with the bookmark, so anything needed durably must be exported to a tracked path.
