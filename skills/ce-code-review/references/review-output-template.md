...
**Scope:** review base bookmark -> working copy (14 files, 342 lines)
...
Described: `fix(review): cover empty-format branch + tighten export perms` (working copy was clean before review).
