...
- Add `vcs-history-analyzer` only when historical rationale or prior art is materially missing
...
- Add VCS commands, commit choreography, or exact test command recipes
