...
**This skill drafts only. It never posts, publishes, changes, or opens PRs.** Posting is a human action. The output is always drafts for you to review, edit, and ship yourself.
...
- **Do not post, publish, schedule, change, or open a PR.** End by reminding the user the drafts are theirs to ship.
