...
1. **JJ activity** — `jj log` over the window (subjects, shas, dates, authors), and for the substantial commits, a stat-level view of what they touched. Group obviously-related commits (a feature bookmark's commits, a fix and its follow-ups) rather than listing them flat.
