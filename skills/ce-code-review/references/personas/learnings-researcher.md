...
> **Search fallback:** If native content and file search are unavailable, use the runtime's documented read-only search capability against `docs/solutions/` with the same patterns and case-insensitivity.
