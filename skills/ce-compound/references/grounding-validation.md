...
| SHA reachable from @ only | Local-only change; SHA will change on rebase/squash merge | Replace with the PR number |
...
| SHA exists but unreachable | Rebased-away change | Replace with the PR number |
