...
- Check for uncommitted changes (`jj st`). If the user has working-copy changes in files that need modification, confirm before editing — do not overwrite in-progress changes.
