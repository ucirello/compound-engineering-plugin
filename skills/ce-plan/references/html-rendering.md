...
- **Composition timestamp.** A visible footer at the bottom of the doc names
  ...
  research-provided source document. Do not add a skill, model, harness,
  creator, generated-by, or assistant byline. Example shape:
...
- **Composition timestamp** is present as a visible footer at the bottom of
  ...
  creator, generated-by, model, harness, or assistant byline.
