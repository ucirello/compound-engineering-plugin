...
- **Inside a JJ workspace:** offer to describe the current change with only the ideation doc included (do not create a bookmark, do not push; if the user declines, leave it undescribed).
