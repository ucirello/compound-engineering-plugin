...
Then follow the same validate -> describe -> push bookmark -> reply -> resolve flow as Full Mode steps 5-7 (in `references/full-mode.md`). Skip validate/describe when no code changed.
