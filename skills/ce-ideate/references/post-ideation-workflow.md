...
- **Inside a JJ repo:** offer to describe only the ideation doc in the current change (do not create a bookmark, do not push; if the user declines, leave it undescribed).
