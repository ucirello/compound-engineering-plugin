...
- **Composition timestamp.** A visible footer at the bottom of the doc contains
  only the composition timestamp. Example shape:
  `<footer class="composition-signal">Composed 2026-05-17T14:23Z</footer>`.
...
want HTML defaults in this workspace can add DESIGN.md to its root.
...
- **Composition timestamp** is present as a visible footer at the bottom of
  the doc and contains only the timestamp.
