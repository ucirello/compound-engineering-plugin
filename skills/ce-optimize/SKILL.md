...
- **Baseline snapshot gate.** Do not continue until the orchestration change is empty and the fixed baseline change ID is recorded. The reference owns the check and safe handling.
