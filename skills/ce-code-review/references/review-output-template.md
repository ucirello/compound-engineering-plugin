...
**Scope:** ancestor with the review base bookmark -> working tree (14 files, 342 lines)
...
Described JJ change: `fix(review): cover empty-format branch + tighten export perms` (working tree was clean before review).
