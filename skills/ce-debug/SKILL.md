...
- If the bug looks like a regression ("it worked before"), use the JJ bisection workflow (see `references/investigation-techniques.md`)
...
- The configured forge remote (a GitHub origin implies GitHub Issues + PRs; `gh` if available).
