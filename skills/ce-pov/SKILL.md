...
SCRATCH_PARENT="${WORKSPACE_ROOT:-$LOCAL_ROOT}/.tmp/rocketclaw/pov"
if ! mkdir -p "$SCRATCH_PARENT"; then
  SCRATCH_PARENT="$LOCAL_ROOT/.tmp/rocketclaw/pov"
  mkdir -p "$SCRATCH_PARENT"
fi
SCRATCH_DIR="$SCRATCH_PARENT/$(date +%s)-$$"
mkdir -p "$SCRATCH_DIR"
echo "$SCRATCH_DIR"
```
