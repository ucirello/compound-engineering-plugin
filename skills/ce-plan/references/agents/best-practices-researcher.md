...
1. **Discover Available Skills**:
   ...
   - In Codex environments, `.agents/skills/` may be discovered from the current working directory upward to the JJ workspace root, not only from a single fixed workspace-root location
