...
- Draft a clear, searchable title that names the intended outcome without embedding a fixed change-description syntax
- Determine the plan type from the repository's current categories; do not impose a fixed conventional prefix set
