...
2. **Otherwise, in a JJ repo**, use the current bookmark versus its base. Without a usable base, use the working-copy change (`jj diff`).
3. **Outside a JJ repo or without a diff**, use files the user named or that were edited earlier in the conversation.
