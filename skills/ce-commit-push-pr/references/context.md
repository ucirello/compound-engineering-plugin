...
| `jj status` | Working-copy state | Not a Jujutsu workspace; stop |
...
Use the default bookmark from `gh repo view`. If unavailable, inspect `jj bookmark list --all-remotes` and use only a uniquely identifiable default.
