...
> Diff-scoped browser QA of `<bookmark-or-change>` vs the trunk. Generated by `/ce-dogfood` on <YYYY-MM-DD>.
...
<What changed between the bookmark/change and trunk: new features, modified behavior, new/changed routes, views, components, data flows. 2-6 bullets.>
