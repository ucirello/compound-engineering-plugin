...
#     node_modules .jj .hg .svn vendor dist build coverage .next .nuxt
...
EXCLUDE_DIRS="node_modules .jj .hg .svn vendor dist build coverage .next .nuxt .svelte-kit .turbo tmp fixtures"
EXCLUDE_ARGS=""
