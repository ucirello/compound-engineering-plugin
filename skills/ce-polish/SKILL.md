...
1. If a PR number or bookmark name was provided, check it out (probe for existing JJ workspaces first).
2. If blank, use the current bookmark or working-copy change.
...
- When the user says they're done → describe/split the JJ change as needed and stop
