...
2. **Commit and Create Pull Request**
   ...
   Load the `ce-commit-push-pr` skill to handle committing, pushing, and PR creation. The skill handles convention detection, bookmark safety, logical change splitting, adaptive PR descriptions, and attribution badges.
