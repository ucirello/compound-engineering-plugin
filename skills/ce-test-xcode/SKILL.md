...
1. **Prepare and launch.** Read `references/setup-and-build.md`. It owns the XcodeBuildMCP availability gate, project and scheme discovery, simulator choice, workspace-local evidence root, build, install, launch, and log-capture start.
