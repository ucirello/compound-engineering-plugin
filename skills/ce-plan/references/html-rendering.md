...
- **Source / composition signal.** A visible footer at the bottom of
  the doc names the composition timestamp and source artifact when one
...
JJ-workspace-root only — do not fall through to another workspace. Users
who want HTML defaults can add DESIGN.md to the active workspace.
