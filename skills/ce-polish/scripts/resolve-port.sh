...
#
# Arguments:
#   path   (optional) -- project root directory. Defaults to the JJ workspace root, or CWD outside JJ.
...
# Default to JJ workspace root when no positional path is given, falling back to CWD.
if [ -z "$PROJECT_ROOT" ]; then
