...
- Analyze only. You are read-only except for the single write to {scratch_artifact_path}.
  Running the bundled analyzer and read-oriented JJ / gh commands are permitted; do not edit
  project files, change bookmarks/workspaces, commit, push, or open PRs.
