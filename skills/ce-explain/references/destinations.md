...
- **Leave it** — report the workspace-local `$RUN_DIR` path, noting that it is temporary and not a durable artifact location; nothing else is written.
