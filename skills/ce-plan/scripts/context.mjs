...
function cli() {
  ...
  // Header first and PLAN_CONTEXT_END last are load-bearing: field transcripts
  ...
  process.stdout.write('=== skill context (follow these directives; if PLAN_CONTEXT_END is missing below, rerun this script once; otherwise do not rerun) ===\n\n');
