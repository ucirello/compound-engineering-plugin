...
## Phase 0: Get on the right change/bookmark
...
3. Verify the current change is not on the default/trunk bookmark.
...
- When the user says they're done → describe the current JJ change with a clear message and stop
