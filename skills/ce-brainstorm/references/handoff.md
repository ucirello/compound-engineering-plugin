...
independent code review and applied fixes, describe/publish/open PR, and CI watch to
...
skills run (plus `jj`, necessary `jj git` interoperability, and `gh` for the PR/CI tail, which it guards when absent).
