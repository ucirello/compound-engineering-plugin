...
1. **Architecture and Structure Analysis**
   - Use the project's active instructions and conventions already supplied by the caller, then examine relevant documentation such as architecture, readme, and contribution guides when present
...
- Treat the project's active instructions and conventions as authoritative when they conflict with generic research advice
