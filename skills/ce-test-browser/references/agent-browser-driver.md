...
# Capture evidence
agent-browser screenshot <workspace-root>/.tmp/rocketclaw/ce-test-browser/<run-id>/viewport.png
agent-browser screenshot --full <workspace-root>/.tmp/rocketclaw/ce-test-browser/<run-id>/full-page.png
