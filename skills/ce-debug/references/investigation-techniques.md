...
```bash
jj bisect start
jj bisect bad                    # current change is broken
jj bisect good <known-good-ref> # a change where it worked
# jj bisect will checkout a middle change — test it
# mark as good or bad, repeat until the breaking change is found
