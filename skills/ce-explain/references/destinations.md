...
3. Keep the visible metadata header and composition footer in the fragment — they are part of the artifact. Do not add generator, platform, product, or `ce-*` attribution while re-emitting it.
