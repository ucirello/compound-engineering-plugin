...
> Diff-scoped browser QA of `<target>` vs the trunk on <YYYY-MM-DD>.
...
<What changed between the target change stack and trunk: new features, modified behavior, new/changed routes, views, components, data flows. 2-6 bullets.>
