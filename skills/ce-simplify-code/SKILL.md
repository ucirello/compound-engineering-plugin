...
argument-hint: "[blank to simplify current bookmark changes, or describe what to simplify]"
---
...
2. **Otherwise, in a Jujutsu repository**, use the current bookmark versus its base. Without a usable base, use working-copy changes (`jj diff`).
3. **Outside a Jujutsu repository or without a diff**, use files the user named or that were edited earlier in the conversation.
