...
- An unrecognized `<word>:<word>` token (including conventional-change prefixes like `feat:` appearing inside a topic) is not a flag — it passes through verbatim as request text.
