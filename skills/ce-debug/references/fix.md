...
Read this before editing any file in Phase 3. SKILL.md runs the bookmark check and records the pre-fix scope before sending you here. Do not repeat either step, and do not ask a second time about a file whose working-copy edits SKILL.md already confirmed.
