...
# Capture evidence
agent-browser screenshot "<workspace-root>/.tmp/rocketclaw/test-browser/<run-id>/screenshot.png"
agent-browser screenshot --full "<workspace-root>/.tmp/rocketclaw/test-browser/<run-id>/screenshot-full.png"
