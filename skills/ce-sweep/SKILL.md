...
- `<writer>` = `ai:assistant/<run-id>`, the neutral, run-unique protocol identity for AI Assistant. Use the same string for every state-engine call this run; do not encode any other identity.
