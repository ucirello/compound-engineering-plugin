...
If no base can be resolved, **stop**. Do not fall back to `jj diff -r @` — a standalone review without the base would only show working-copy changes and silently miss all committed work on the bookmark.
