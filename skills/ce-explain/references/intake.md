...
|-------|---------|--------|
| `diff:<revision-or-range>` | `diff:@`, `diff:main..@`, `diff:PR#42` | Forces diff mode on that change |
...
- **Diff** — the request names a resolvable JJ change, commit, bookmark, revision range, or PR: an ID, `@`, "the last change", "what you just did", "this change".
