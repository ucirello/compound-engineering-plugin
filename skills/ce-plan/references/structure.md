...
- Draft a clear, searchable title from the work's meaning, without a fixed prefix template
- Determine the plan type from the change intent (the `type` metadata field)
- Build the filename following the repository convention: `<root>/plans/YYYY-MM-DD-HHMM-<type>-<descriptive-name>-plan.md`
  ...
  - Examples: `2026-01-15-0915-<type>-user-authentication-flow-plan.md`, `2026-02-03-1642-<type>-checkout-race-condition-plan.md`
...
Break the work into logical implementation units. Each unit should represent one meaningful change that an implementer could typically land as one Jujutsu change.
