...
Then follow the same validate -> describe/create JJ change -> push -> reply -> resolve flow as Full Mode steps 5-7 (in `references/full-mode.md`). Skip validate and JJ change creation when no code changed.
