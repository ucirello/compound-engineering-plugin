...
Blocking: the required local greeting catalogue at data/greetings.json has not been supplied. R1 must use its approved greeting values; implementation cannot start until those values are available.
