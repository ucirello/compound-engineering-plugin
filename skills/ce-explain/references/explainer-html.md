...
How an explainer renders as HTML. Load at compose time (Phase 4), not earlier. The explainer is a personal teaching artifact — these rules keep it self-contained, readable, and clear about its source material. It is not a plan artifact: no navigation region, no R/U-ID anchors, no contract sections.
